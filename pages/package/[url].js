                            ...
                            return (
                                <div className="col-md-4" key={index}>
                                    <div className="package-box">
                                        <figure><Link href="/package-detail"><img src={slide.image} alt="" title=""/></Link></figure>
                                        <div className="p-content">
                                        <h3><a href="package-detail">{slide.hotel_name}</a></h3>
                ...
                <div className="packages-by-destination">
                    ...
                    <div className="row">
                        ...
                        <div className="p-by-box">
                            <figure> <Link href="/package-detail"><img src="/Images/destinations/kolkata.jpg" alt="" title=""/></Link> </figure>
                            <h4><a href="#">Kolkata</a></h4>
                        </div>
                        </div>
                        <div className="col-sm-3">
                        <div className="p-by-box">
                            <figure> <Link href="/package-detail"><img src="/Images/destinations/mumbai.jpg" alt="" title=""/></Link> </figure>
                            <h4><a href="#">Mumbai</a></h4>
                        </div>
                        </div>
                        <div className="col-sm-3">
                        <div className="p-by-box">
                            <figure> <Link href="#"><img src="/Images/destinations/banglore.jpg" alt="" title=""/></Link> </figure>
                            <h4><a href="#">Banglore</a></h4>
                        </div>
                        </div>
                    <div className="col-sm-3">
                        <div className="p-by-box">
                            <figure> <Link href="#"><img src="/Images/destinations/chennai.jpg" alt="" title=""/></Link> </figure>
