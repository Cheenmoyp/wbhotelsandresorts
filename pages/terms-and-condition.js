...
Without limitation, you must not use any of the said trade or service marks:
          ...
          <ul>
			...
			<li>in connection with activities, products or services which are not undertaken or provided by WB Hotels;</li>
			<li>in a manner which may be confusing, misleading or deceptive; or</li>
			<li>in a manner that disparages WB Hotels or its information, products or services (including this Site).</li>
...
WB Hotels does not guarantee that the Site will operate continuously or without interruption or be error free. In addition, WB Hotels may also suspend or discontinue any aspect of the Site at any time without being liable for any direct or indirect loss as a result of such action.
				  ...
				  <p>
				  In no event shall WB Hotels be responsible for any direct, indirect, special, incidental or consequential loss or damage, however arising and whether in contract, tort or otherwise, which you may suffer in connection with or arising out of:
						<ul>
...
You must take your own precautions that the process which you employ for accessing the Site does not expose you to the risk of virus, malicious computer code, computer program routine or process or other forms of interference which may damage your own computer system. Without limitation, you are responsible for ensuring that your own computer system meets all relevant technical specifications necessary to use the Site and is compatible with the Site. For the removal of doubt, WB Hotels does not accept responsibility for any interference or damage to your own computer system which arises in connection with your use of the Site or any Linked Web Site.<br/>
WB Hotels does not guarantee or warrant that any material available for downloading from the Site or any Linked Web Site will be free from any virus, infection or other condition which has contaminating or destructive properties. You are responsible for taking sufficient precautions and checks to satisfy your own particular requirements for accuracy of data input and output.
You must ensure that any information which you provide to WB Hotels is accurate and complete and does not contain any virus, malicious computer code, computer program routine or process or other form of interference which may damage the computer system of WB Hotels or the Information or which may detrimentally interfere with or surreptitiously intercept or expropriate any WB Hotels system, data or information.
...
The Site contains details of hotel charges and room rates (including any available special offers) for hotels and resorts owned or managed by WB Hotels.<br/>
...
No contract will subsist between you and WB Hotels or any of its affiliates in respect of any services or products offered through the Site unless and until WB Hotels accepts your order by e-mail or automated confirmation through the Site confirming that it has accepted your reservation, booking or order and any such contract shall be deemed to incorporate the hotel reservation terms and conditions of booking. Any other relevant terms and conditions relating to particular services or products are set out in the Site.
You undertake that all details you provide to in connection with any services or products which may be offered by WB Hotels on the Site (including hotel room reservations) will be correct and, where applicable, the credit card which you use is your own and that there are sufficient funds to cover the cost of any services or products which you wish to purchase. WB Hotels reserves the right to obtain validation of your credit card details before providing you with any services or products.
...
WB Hotels does not warrant and cannot ensure the security or confidentiality of any information which you transmit to WB Hotels. Accordingly, any information which you transmit to WB Hotels is transmitted at your own risk.
</p>
...
Otherwise access to the Site may be terminated at any time by WB Hotels without notice.
The provisions of these Conditions excluding, limiting and disclaiming the liability of WB Hotels will nevertheless survive any such termination.
</p>
		<h2>General</h2>
		
		<p>WB Hotels does not accept any liability for any failure by WB Hotels to comply with these Conditions where such failure is due to circumstances beyond its reasonable control.
If WB Hotels waives any rights available to it under these Conditions on one occasion, this does not mean that those rights will automatically be waived on any other occasion.
